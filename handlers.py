...
#     def start(message):
#         keyboard = types.ReplyKeyboardMarkup(resize_keyboard=True)
#         keyboard.add(types.KeyboardButton(text="/list"))
#         keyboard.add(types.KeyboardButton(text="/select_crypto"))
#         bot.send_message(
#             message.chat.id,
#             f"Привет, {message.from_user.first_name}! Я бот для скальпинга криптовалют VSEVOLOD.\n\n"
#             "Для начала выбери одну из следующих опций:",
#             reply_markup=keyboard,
#         )
...
#             message.chat.id,
#             "Это бот для скальпинга криптовалют. "
#             "Доступные команды:\n/select_crypto - выбрать криптовалюту для скальпинга\n/list - просмотреть доступные криптовалюты\n/help - помощь",
#         )
...
#             bot.send_message(
#                 message.chat.id,
#                 f"Ты уже добавил {selected_crypto} для скальпинга!\nВыбери что-то еще или переходи к выбору /list",
#             )
#         else:
#             bot.send_message(
#                 message.chat.id, f"Ты выбрал {selected_crypto} для скальпинга!"
